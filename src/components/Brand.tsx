...
function Brand() {
  ...
  return (
    <div className="flex flex-col gap-[60px] md:gap-[110px] py-10 md:py-20 xl:py-40">
      <motion.div
        className="text-[28px] sm:text-[36px] md:text-[42px] leading-[100%] font-['Roboto_Condensed'] font-bold tracking-[-0.02em] text-center uppercase text-black px-4 sm:px-10 md:px-20 xl:px-[228px]"
      ...
      <div className="px-2 sm:px-8 xl:px-[164px] flex flex-col gap-8 md:gap-[47px]">
        {brandRows.map((row, rowIndex) => (
          <motion.div
            ...
            className={
              ...
              (rowIndex === 0
                ? "md:px-2 md:gap-10 xl:px-[81px] xl:gap-[120px]"
                : rowIndex === 2
                ? "xl:xl-9"
                : "")
            }
